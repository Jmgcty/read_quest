...
class ReaderMoreSettingsScreen extends ConsumerStatefulWidget {
  const ReaderMoreSettingsScreen({super.key});

  @override
  ConsumerState<ReaderMoreSettingsScreen> createState() =>
      _ReaderMoreSettingsScreenState();
}

class _ReaderMoreSettingsScreenState
    extends ConsumerState<ReaderMoreSettingsScreen> {
  void logout() async {
    await AwesomeDialog(
      context: context,
      ...
      btnOkOnPress: () async {
        ...
        ref.read(readerPageProvider.notifier).resetPage();
      },
    ).show();
  }
